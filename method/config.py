...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--visual_feat_dim", type=int, default=1024, help="feature dim for query feature")
        ...
        self.parser.add_argument('--dataset_name', type=str)
        ...
        self.parser.add_argument('--caption_train_txt', type=str, default='')
        self.parser.add_argument('--caption_test_txt', type=str, default='')
        self.parser.add_argument('--neg_query_loss', type=str, default='')
        self.parser.add_argument('--fusion_weight', type=float, default=0.5)
        self.parser.add_argument('--neg_query_loss_weight', type=float, default=1.0)
        self.parser.add_argument('--neg_action_num', type=int, default=5)
        self.parser.add_argument('--neg_object_num', type=int, default=5)
        self.parser.add_argument('--cross_attn_head', type=int, default=4)
        self.parser.add_argument('--neg_query_loss_branch', type=str, default='both')
        self.parser.add_argument('--max_type', type=str, default='max_pos')
        self.parser.add_argument('--deformable_attn', default=False, action='store_true')
        self.parser.add_argument('--deformable_key', type=str, default='private')
        self.parser.add_argument('--deformable_offset_kernel_size', type=int, default=3)
        self.parser.add_argument('--downsample_factor', type=int, default=3)
        self.parser.add_argument('--deformable_heads', type=int, default=4)
        self.parser.add_argument('--deformable_offset_scale', type=int, default=8)
        self.parser.add_argument('--deformable_offset_groups', type=int, default=8)
        self.parser.add_argument('--deformable_offset_num', type=int, default=8)
        self.parser.add_argument('--cross_attn_q', type=str, default='i3d_q')
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            opt.model_dir = os.path.join(opt.root_path, opt.dataset_name,"results_26aaai",opt.model_dir)

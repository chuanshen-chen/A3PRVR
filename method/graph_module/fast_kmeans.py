...
if __name__ == "__main__":
    visual_output = torch.rand(128, 3*32, 512)
    video_mask = torch.ones(128, 96)
    assign, medoids = batch_fast_kmedoids(visual_output,5)
    idx = torch.arange(visual_output.shape[0], device=visual_output.device).unsqueeze(-1)
